...
public:
	...
	#ifndef NO_COOKIE
	static		int8_t attachInterrupt(uint8_t pin, PCIntvoidFuncPtr userFunc, int mode, void *cookie = NULL);
	#else
...
#ifndef NO_COOKIE
	int8_t		addPin(uint8_t arduinoPin,PCIntvoidFuncPtr userFunc, uint8_t mode, void *cookie = NULL);
#else
...
#endif
#ifndef NO_COOKIE
volatile void* PCintPort::cookie=NULL;
#endif
#ifdef PINMODE
...
#ifndef NO_COOKIE
int8_t PCintPort::addPin(uint8_t arduinoPin, PCIntvoidFuncPtr userFunc, uint8_t mode, void*cookie)
#else
 ...
 */
#ifndef NO_COOKIE
int8_t PCintPort::attachInterrupt(uint8_t arduinoPin, PCIntvoidFuncPtr userFunc, int mode, void*cookie)
#else
...
#ifndef NO_COOKIE
	return(port->addPin(arduinoPin,userFunc,mode,cookie));
#else
